...
if (!$invoiceQ || $invoiceQ->num_rows == 0) {
    die("Invoice Not found or unauthroized access!");
}
...
<head>
    ...
    <title>Invoice - <?= $invoice["order_order_id"]; ?> | SkillShop</title>
...
<body class="bg-gray-50 min-h-screen py-10">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6 no-print">
            <a href="buyer-dashboard.php" class="text-blue-600 font-bold hover:blue-800 flex items-center gap-2 transition-colors">
                ⬅️ Back to Dashboard
            </a>
        ...
        <div class="bg-white p-8 md:p-12 rounded-2xl shadow-xl print-shadow-none border border-transparent print-border">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-8 mb-8">
                ...
                <div class="mt-6 md:mt-9 text-left md:text-right">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-10">
                ...
                <div class="md:text-right flex flex-col items-start md:items-end">
                    ...
                    <div class="bg-green-50 text-green-700 px-4 py-2 rounded-lg font-bold text-sm inline-flex items-center gap-2 border border-green-100 mb-3">
                        💳
                        PAID (Payhere)
                    </div>
            ...
            <div class="overflow-x-auto-mb">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php while ($item = $itemQ->fetch_assoc()): ?>
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="py-5 px-2">
                                    <span class="text-xs text-white font-bold px-2   py-1 rounded bg-slate-600 uppercase"><?= $item["level"]; ?></span>
                                </td>
            ...
            <div class="mt-16 pt-8 border-t border-gray-100 text-center text-sm text-gray-500">
                ...
                <p>If you have any question regarding this invoice, Please contact support@skillshop.com</p>

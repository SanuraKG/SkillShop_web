...
$merchantId = "1234606";
$merchantSecret = "NzE5NzM4MjEwMzgwMzA1ODI2NjM5MDMzMzA0OTU1ODgwNzEyMTM=";
$currency = "LKR";
...
$userQ = Database::search(
    "SELECT
u.`fname`,u.`lname`,u.`email`,up.`mobile`,a.`line1`,a.`line2`,c.`name` AS `city_name`,
...
if (!$user) {
    echo json_encode(["success" => false, "message" => "Please complete your profile with a full address before checkout."]);
    exit;
}
...
$paymentObject = [
    ...
    "return_url" => "http://localhost/skillshop/buyer-dashboard.php?tab=cart",
    "cancel_url" => "http://localhost/skillshop/buyer-dashboard.php?tab=cart",
    "notify_url" => "http://localhost/skillshop/buyer-dashboard.php?tab=cart",
    "order_id" => $orderId,

...
<body class="bg-slate-50 min-h-screen">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="p-8">
                <div class="bg-white rounded-2xl shadow-sm border borders-slate-100">
...
font-bold text-slate-400">
                                    ...
                                    <td class="px-8 py-5 text-right">
                                        <button onclick="toggleUserStatus(<?= $user['id']; ?>);" id="btn-<?= $user["id"]; ?>" class="px-4 py-2 rounded-lg text-xs font-bold transition-all
                                        <?= ($user["status"] == "active") ? "bg-red-50 text-red-600 hover:bg-red-600 hover:text-white" : "bg-green-600 text-white hover:bg-green-700"; ?>
                                        ">

    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <aside class="w-full md:w-64 bg-slate-900 text-white flex-shrink-0">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="admin-products.php" class="flex items-center gap-3 px-4 py-3 hover:bg-blue-600 rounded-xl text-sm font-medium transition-colors">
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                        ...
                        <h3 class="text-2xl font-black text-slate-900">Rs. <?= number_format($totalEarnings, 2); ?></h3>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                        <div class="flex justify-between items-start mb-4">
                            <span class="p-3 bg-blue-50 text-blue-600 rounded-xl text-xl">📜</span>
                            <span class="text-[10px] font-bold text-green-500 uppercase">Scale</span>
                        </div>
                            ...
                            ?>
                                <div>
                                    <div class="flex justify-between text-xs mb-1">
                                        <div class="font-bold text-slate-700"><?= $cat["name"] ?></div>
                                        <div class="text-slate-500"><?= number_format($percent, 1) ?>%</div>
                                    </div>
                        ...
                        <table class="w-full text-left">
                            <thead>
                                <tr class="bg-slate-50/50 text-slate-500 text-[10px] font-bold uppercase tracking-wider">
                                    <th class="px-9 py-4">Order ID</th>
                                    <th class="px-9 py-4">Buyer</th>
                                    <th class="px-9 py-4">Product</th>
                                    <th class="px-9 py-4">Amount</th>
                                    <th class="px-9 py-4">Status</th>
                                ...
                                <?php if ($recentOrders && $recentOrders->num_rows > 0): ?>
                                    <?php while ($order = $recentOrders->fetch_assoc()): ?>
                                        <tr class="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td class="px-8 py-4 text-sm text-slate-600 font-medium">Rs. <?= number_format($order["total_amount"], 2); ?></td>
                                            <td class="px-8 py-4">
